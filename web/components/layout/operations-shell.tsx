...
const links = [{ href: "/orders", label: "Pedidos", mark: "01" }, { href: "/approvals", label: "Aprobaciones", mark: "02" }];
export function OperationsShell({ children }: { children: React.ReactNode }) {
  ...
  return <div className="min-h-screen bg-[var(--paper-50)] text-[var(--ink-950)] lg:flex">
    ...
    <aside className="bg-[var(--ink-950)] text-[var(--paper-50)] lg:flex lg:w-64 lg:flex-col">
